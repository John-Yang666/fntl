...
import RestartCommandComponent from '@/components/RestartCommandComponent.vue';
...
function __VLS_template() {
    ...
    // @ts-ignore
    var __VLS_0 = __VLS_asFunctionalComponent(RestartCommandComponent, new RestartCommandComponent({}));
...
var __VLS_self = (await import('vue')).defineComponent({
    setup: function () {
        return {
            RestartCommandComponent: RestartCommandComponent,
        };
    },
});
