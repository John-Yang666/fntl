...
def create_relayaction_device_timestamp_index(apps, schema_editor):
    ...
    with schema_editor.connection.cursor() as cursor:
        cursor.execute(
            """
            CREATE INDEX CONCURRENTLY IF NOT EXISTS sy_relay_dev_ts_desc_idx
...
def drop_relayaction_device_timestamp_index(apps, schema_editor):
    ...
    with schema_editor.connection.cursor() as cursor:
        cursor.execute("DROP INDEX CONCURRENTLY IF EXISTS sy_relay_dev_ts_desc_idx")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("myapp", "0022_cleanup_timestamp_indexes"),
    ]
        ...
        migrations.SeparateDatabaseAndState(
            ...
            state_operations=[
                migrations.AddIndex(
                    ...
                    index=models.Index(fields=["device", "-timestamp"], name="sy_relay_dev_ts_desc_idx"),
                ),
            ],
        ),
    ]
